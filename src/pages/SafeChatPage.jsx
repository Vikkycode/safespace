...
const SafeChatPage = () => {
  return (
   ...
   <div className='flex justify-center items-center flex-col'>
       <div className='flex justify-center items-center py-10 sm:py-0  space-x-4'>
           <LazyLoadedImage 
           src={safechat} 
   ...
   <div className='sm:py-6 px-4 sm:px-6 mx-4 sm:mx-20 sm:h-[412px] text-center sm:max-w-[1257px]'>
   ...
   <div className='py-6 px-4 sm:-mt-40 flex justify-between gap-4 items-center flex-col sm:flex-row'>
     ...
     <div className='mx-20'>
       ...
       <div className='text-end sm:text-center flex justify-between items-center'>
        <a className='font-[400] text-2xl text-[#415D43] hidden sm:block'>FAQs</a>
