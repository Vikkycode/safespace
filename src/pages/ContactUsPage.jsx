...
const ContactUsPage = () => {
  return (
    <section className='py-6 h-full'>
        ...
        <div className='py-6 px-4 sm:px-6 mx-4 sm:mx-20 sm:h-[412px] text-center sm:max-w-[1257px]'>
        ...
        <div className='py-6 px-4 sm:px-6 mx-4 sm:mx-20 sm:-mt-40 flex justify-betweeen gap-4 items-center flex-col sm:flex-row'>
          <div className='w-[350px] sm:w-[302px] h-[187px] text-center bg-[#f9f9f9] gap-[20px] flex flex-col justify-start pt-8 items-center'>
          ...
          <div className='w-[350px] sm:w-[302px] h-[187px]text-center bg-[#f9f9f9] gap-[20px] py-6 sm:py-0  flex flex-col justify-center items-center'>
          ...
          <div className='w-[350px] sm:w-[302px] h-[187px] text-center bg-[#f9f9f9] gap-[20px] flex flex-col justify-center items-center'>
          ...
          <div className='w-[350px] sm:w-[302px] py-6 sm:py-0 sm:h-[187px]text-center bg-[#f9f9f9] gap-[20px] flex flex-col justify-center items-center'>
