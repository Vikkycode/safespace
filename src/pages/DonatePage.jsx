  ...
  return (
    <section className='mx-auto max-w-screen-xl sm:py-12 space-y-8 lg:py-16 px-4 sm:px-6  lg:px-20'>
        <div className='flex justify-center items-center flex-col'>
            ...
            <p className='font-bold text-center text-sm sm:text-3xl sm:max-w-lg'>small changes make a big impact on people lives
</p>
            ...
            <div className='text-start flex justify-between items-center'>
                ...
                <div className='h-[19px] border border-[#000] w-[107px] py-[16px] px-[13px] gap-[25px] opacity-100 flex justify-center items-center  sm:hidden'>
                    <Link to="" className='font-[400] sm leading-[10.89px]'>fast action</Link>
                </div>
            </div>
            <div className='space-y-10 justify-start flex'>
                <form action="">
                    <div className='flex sm:items-center items-start flex-col sm:flex-row sm:space-x-4 pb-8'>
                    <input type="radio" name="" id="" />
                    <p className='font-sans font-[400] text-[10px] sm:text-sm'>one time payment</p>
                    </div>
                    <div className='flex sm:items-center items-start flex-col sm:flex-row sm:space-x-4'>
                    <input type="radio" name="" id="" />
            ...
            <div className='space-y-4'>
                <p className='font-sans font-[400] text-[10px] sm:text-sm'>Your monthly gift makes you an important source of support for SafeHer</p>
                <div className='flex justify-between items-center'>
                <div className='border border-[#757575] w-[60px] h-[32px]  sm:w-[191px] sm:h-[71px] flex justify-center items-center'>
            ...
            <div className='space-y-10'>
                ...
                <div className='flex justify-between items-start sm:items-center space-y-4 flex-col sm:flex-row'>
                <p className='font-sans font-[400] text-[10px] sm:text-2xl text-[#415D43] border-b-2 border-[#415D43]'>donation FAQs</p>
                <div className='flex justify-between items-center space-x-5'>
                
                
                <div className='border border-[#757575] w-[100px] h-[32px]  sm:w-[191px] sm:h-[71px] flex justify-center items-center'>
            ...
            <div className='flex justify-center items-center py-10  space-x-4 border-b-2 pb-4 text-black'>
                <Logo className="h-[32px] w-[32px] sm:h-[92.63px] sm:w-[84.3px] text-[#415D43]" />
            ...
            <div className='flex items-start sm:items-center  flex-col pt-4'>
                <div className='flex justify-start space-x-6 items-start'>
