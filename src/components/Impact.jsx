...
<section>
  <div 
   class="max-w-screen-xl py-8 sm:h-screen  sm:py-12  lg:py-8  px-4 sm:px-6 lg:pl-4 lg:pr-20">
    <h1 data-aos="fade up" 
 data-aos-duration="3000" className='text-[16px] leading-[27.3px] py-4 font-bold text-center text-gray-900 md:text-3xl'>Our impacts</h1>
 ...
 data-aos-duration="3000" className='hidden sm:block'>
        <h2 
        data-aos="fade up" 
        data-aos-duration="3000"
        class="text-xl font-bold sm:text-2xl">0ur Vision</h2>
        <p 
        data-aos="fade up" 
        data-aos-duration="3000"
        class="mt-4 text-[#757575] font-sans sm:text-2xl text-center sm:text-start w-[266px] h-[33px] sm:w-[1079px] sm:h-[82px]">
...
We offer a safe, supportive platform for survivors of sexual and gender-based violence, promoting community connections, resource access, and advocacy for change, ensuring confidentiality and respect.
       ...
       data-aos-duration="3000"
        ...
        data-aos="fade up" 
        data-aos-duration="3000"
        class="mt-16 text-center  sm:text-left md:mt-8">
