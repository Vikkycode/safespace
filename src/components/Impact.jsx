  ...
  <section>
    <div 
     class="max-w-screen-xl py-8 sm:h-screen  sm:py-12  lg:py-8  px-4 sm:px-6 lg:pl-4 lg:pr-20">
      <h1 data-aos="fade up" 
   data-aos-duration="1000" className='text-[16px] leading-[27.3px] py-4 font-bold text-center text-gray-900 md:text-3xl'>Our impacts</h1>
   ...
   data-aos-duration="1000" className='hidden sm:block'>
          <h2 
          data-aos="fade up" 
