...
<section class="flex justify-between px-4 flex-col sm:flex-row sm:px-6  lg:px-20">
  <div class=" lg:py-24">
    <div class="mx-auto max-w-xl text-center sm:text-start">
      <h2 class="text-[16px] leading-[27.3px] py-4 font-[700] text-start text-gray-900 md:text-3xl">
      Join Our Team
      </h2>

      <p class="text-[#757575] font-[400] font-sans md:text-sm md:text-2xl md:mt-4 md:block text-center sm:text-start w-[350px] sm:w-[501px] sm:h-[198px]">
  ...
  <div className="grid grid-cols-2 gap-x-2 sm:gap-x-6 mt-10  sm:grid-cols-2">
          <span className="inline-flex flex-col justify-center items-center bg-[#f6f6f6] h-[110px] w-[165px] sm:h-[223px] sm:w-[290px]  p-3">
            <LazyLoadedImage 
            src={diversity} 
          ...
          <span className="inline-flex flex-col justify-center items-center rounded-lg bg-[#f6f6f6] h-[110px] w-[165px] sm:h-[223px] sm:w-[290px]  p-3">
            <LazyLoadedImage 
            src={target} 
            className='h-[84px] w-[61px]' 
            alt="give we give" />
          ...
          <span className="inline-flex  mt-4 md:mt-8 flex-col justify-center items-center rounded-lg bg-[#f6f6f6] h-[110px] w-[165px] sm:h-[223px] sm:w-[290px]  p-3">
            <LazyLoadedImage 
            src={selfcare} 
            className='h-[84px] w-[61px]' 
            alt="self care" 
